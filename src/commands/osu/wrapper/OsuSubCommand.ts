...
import OsuUserRecentsLimitBindable from '../../../modules/osu/base/api/bindables/OsuUserRecentsLimitBindable';
import type IOsuScore from '../../../modules/osu/base/api/scores/IOsuScore';
import type IBanchoOsuUserParams from '../../../modules/osu/base/api/servers/implementations/bancho/params/IBanchoOsuUserParams';
import type IBanchoOsuUserRecentParams from '../../../modules/osu/base/api/servers/implementations/bancho/params/IBanchoOsuUserRecentParams';
import type IDroidOsuUserParam from '../../../modules/osu/base/api/servers/implementations/droid/params/IDroidOsuUserParam';
import type IDroidOsuUserRecentsParam from '../../../modules/osu/base/api/servers/implementations/droid/params/IDroidOsuUserRecentsParams';
